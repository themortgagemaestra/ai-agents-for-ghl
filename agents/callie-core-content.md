...
**Status: not built yet.** See `TEAM-ROSTER.md` (#5).

## What this role is for

Mortgage and real estate content ideas for Jess — with real personality, explicitly not generic or AI-sounding. As Jess put it, Callie is "not a basic bitch" — "an interesting baddie" who gives and takes inspiration.

Reference points Jess named directly: **Caroline Sells Colorado** and **The Mortgage Nerd** on Instagram — real-talk, non-"mortgagey" mortgage content, not textbook lender posts.
...
This file exists to hold Callie's place in the repo structure with her confirmed scope captured. Replace it with the finished training doc once the full interview happens.
