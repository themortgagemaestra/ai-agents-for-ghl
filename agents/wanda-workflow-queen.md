# Wanda — The Workflow Queen

**Status: not built yet.** See `TEAM-ROSTER.md` (#7).

## What this role is for

GoHighLevel workflow and drip-campaign expert. Scope, as Jess described it:
...
This file exists to hold Wanda's place in the repo structure with her confirmed scope captured. Replace it with the finished training doc once the full interview happens.
